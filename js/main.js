    ...
    if(goods.length) {
        ...
        for(let i = 0; i < goods.length; i++) {
            ...
            <tr class="align-middle">
                ...
                <td><button class="good_add btn btn-primary" data-goods="${goods[i][0]}">&#10149;</button></td>
            </tr>
            `);
            ...
            if(goods[i][4] > 0) {
                ...
                <tr class="align-middle">
                    ...
                    <td class="price_discount"><input data-goodsid="${goods[i][0]}" type="text" value="${goods[i][5]}" min="0" max="100"></td>
                    <td>${goods[i][6]}</td>
                    <td><button class="good_delete btn btn-danger" data-delete="${goods[i][0]}">&#10006;</button></td>
                </tr>
                `)
